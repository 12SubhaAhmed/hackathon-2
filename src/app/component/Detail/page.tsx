      ...
      <div className="md:flex-1 mt-8 px-8 border-2">
        ...
        <div className="sm:flex  gap-6">
          ...
          <div className="w-[327px] h-[318px] mt-5 sm:mt-0 lg:w-[492px] space-y-10 cursor-pointer lg:h-[408px] ">
           ...
           <Link href={"http://localhost:3000/billing"}>
            <button className="ml-40 bg-blue-700 w-[140px] h-14 rounded-md text-white hover:shadow-[0_0_4px_1px_black] transition-all">Rent Now</button>
            </Link>
            </div>
          </div>
        </div>
