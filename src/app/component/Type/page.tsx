...
export default function Type() {
  ...
  const carData = [
    ...
    { name: "All New Terios", image: "/Images/car7.png", price: "$74.00 / day" },
    { name: "MG ZX Exclusice", image: "/Images/car8.png", price: "$76.00 / day" },
    { name: "New MG ZS", image: "/Images/car9.png", price: "$80.00 / day" },
    { name: "MG ZX Excite", image: "/Images/car10.png", price: "$74.00 / day" }
  ];
